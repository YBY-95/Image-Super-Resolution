...
if __name__ == '__main__':
    ...
    database_dir = r'D:\DATABASE\ZXJ_GD\var_speed_sample\DG'
    out_dir = r'D:\DATABASE\ZXJ_GD\var_speed_sample\DG_SR_sample'
    ...
    parser.add_argument('--n_worker', type=int, default=96)
    ...
    for filepath, dirnames, filenames in os.walk(database_dir):
        for dirname in dirnames:
            for filepath_2, dirnames_2, filenames_2 in os.walk(os.path.join(database_dir,
                                                                            dirname)):
                for dirname_2 in dirnames_2:
                    out_path = os.path.join(out_dir, dirname)
                    if os.path.exists(out_path) is False:
                        os.makedirs(out_path)
                    setattr(args, "path", os.path.join(database_dir, dirname, dirname_2))
                    setattr(args, "out", os.path.join(out_path, dirname_2))
